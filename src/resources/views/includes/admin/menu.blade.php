            ...
            <div class="app-menu navbar-menu">
                ...
                <div class="navbar-brand-box">
                    ...
                    <a href="{{route('dashboard')}}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ Vite::asset('resources/images/fav/android-icon-192x192.png')}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                    ...
                    <a href="{{route('dashboard')}}" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ Vite::asset('resources/images/fav/android-icon-192x192.png')}}" alt="" height="30">
                        </span>
                        <span class="logo-lg">
