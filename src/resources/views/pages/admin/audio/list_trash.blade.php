                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-warning remove-item-btn" data-link="{{route('audio_restore_trash', $item->id)}}">Restore</button>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" data-link="{{route('audio_delete_trash', $item->id)}}">Remove</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
