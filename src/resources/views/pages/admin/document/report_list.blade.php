                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm row mt-4 justify-content-end">
                                    @include('includes.admin.filter_search_report_form', [
                                        'url' => route('document_view_report'),
                                    ])
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 align-items-center">
                                                    ...
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" data-link="{{route('document_delete_report', $item->id)}}">Delete</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
@include('includes.admin.call_search_handler', ['url'=>route('document_view_report')])
