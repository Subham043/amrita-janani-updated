                    ...
                    <div class="card-body">
                        <div class="row g-4 mb-3">
                            <div class="col-sm">
                                ...
                                <button type="button" class="btn btn-info add-btn me-2 remove-item-btn" data-link="{{route('image_restore_trash', $country->id)}}" id="create-btn"><i class="ri-save-line align-bottom me-1"></i> Restore</button>
                                <button type="button" class="btn btn-danger add-btn remove-item-btn" data-link="{{route('image_delete_trash', $country->id)}}" id="create-btn"><i class="ri-delete-bin-line align-bottom me-1"></i> Delete</button>
                                </div>
                            </div>
                        </div>
