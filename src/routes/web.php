...
Route::middleware(['guest'])->group(function () {
    ...
    Route::get('/reset-password/{token}', [ResetPasswordPageController::class, 'index', 'as' => 'reset_password.index'])->name('resetPassword')->middleware('signed');
    Route::post('/reset-password/{token}', [ResetPasswordPageController::class, 'requestResetPassword', 'as' => 'reset_password.requestResetPassword'])->name('resetPasswordRequest')->middleware('signed');
